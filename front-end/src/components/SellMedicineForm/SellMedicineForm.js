...
function SellMedicineForm({ medicine }) {
  return (
    <form>
      <div className="row">
        <div className="col">
          <div className="mb-3">
            ...
            <input type="number" className="form-control" id="medicineID" value={medicine.id} />
          </div>
          <div className="mb-3">
            <label htmlFor="genericName" className="form-label">
              Генерично лекарство
            </label>
            <input type="text" className="form-control" id="genericName" value={medicine.genericName} />
          </div>
          <div className="mb-3">
            <label htmlFor="brandName" className="form-label">
              Търговско име
            </label>
            <input type="text" className="form-control" id="brandName" value={medicine.brandName}/>
          </div>
        </div>
        <div className="col">
          <div className="mb-3">
